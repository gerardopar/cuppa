...
export const TechnologyPage: React.FC = () => {
  const { data: technology, isPending: technologyPending } = useGetNews({
    q: NewsCategoriesEnum.technology,
    language: "en",
    pageSize: 20,
  });

  const articles = useMemo(
    () => getRandomArticles(technology?.articles ?? [], 20),
    [technology]
  );
